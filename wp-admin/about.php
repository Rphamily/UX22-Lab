 ...
 printf( __( 'WordPress %s' ), $display_version ); ?>
		...
		<div class="about__section changelog has-subtle-background-color">
			<div class="column">
				...
				<p>
					<?php
 printf( _n( '<strong>Version %1$s</strong> addressed some security issues and fixed %2$s bug.', '<strong>Version %1$s</strong> addressed some security issues and fixed %2$s bugs.', 21 ), '6.4.3', '21' ); ?>
					<?php
 printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), sprintf( esc_url( __( 'https://wordpress.org/support/wordpress-version/version-%s/' ) ), sanitize_title( '6.4.3' ) ) ); ?>
				</p>

				<p>
					<?php
 printf( _n( '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bug.', '<strong>Version %1$s</strong> addressed a security issue and fixed %2$s bugs.', 7 ), '6.4.2', '7' ); ?>
					<?php
 printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), sprintf( esc_url( __( 'https://wordpress.org/support/wordpress-version/version-%s/' ) ), sanitize_title( '6.4.2' ) ) ); ?>
				</p>

				<p>
					<?php
 printf( _n( '<strong>Version %1$s</strong> addressed %2$s bug.', '<strong>Version %1$s</strong> addressed %2$s bugs.', 4 ), '6.4.1', '4' ); ?>
					<?php
 printf( __( 'For more information, see <a href="%s">the release notes</a>.' ), sprintf( esc_url( __( 'https://wordpress.org/support/wordpress-version/version-%s/' ) ), sanitize_title( '6.4.1' ) ) ); ?>
				</p>
			</div>
		</div>
 ...
 printf( __( 'Experience the latest advancements in site editing with <a href="%s">Twenty Twenty-Four</a>. Built with three distinct use cases in mind, the versatility of the new default theme makes it an ideal choice for almost any type of website. Dive into its collection of templates and patterns and unlock a world of creative possibilities with just a few tweaks.' ), __( 'https://make.wordpress.org/core/2023/08/24/introducing-twenty-twenty-four/' ) ); ?>
		...
		<div class="about__section has-3-columns">
			...
			<div class="column">
				...
				<p>
					<?php
 printf( __( 'Enjoy <a href="%s">a refreshed design and more commands</a> to find what you\'re looking for, perform tasks efficiently, and save time as you create.' ), __( 'https://make.wordpress.org/core/2023/09/12/core-editor-improvement-commanding-the-command-palette/' ) ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns has-subtle-background-color is-wider-left">
			...
			<div class="column is-vertically-aligned-center">
				...
				<p>
					<?php
 printf( __( '<a href="%s">New enhancements</a> ensure your content creation journey is smooth. Find new keyboard shortcuts in List View, refined list merging, and enhanced control over link settings. A revamped and cohesive toolbar experience for Navigation, List, and Quote blocks lets you efficiently work with the tooling options you need.' ), __( 'https://make.wordpress.org/core/2023/10/05/core-editor-improvement-ensuring-excellence-in-the-writing-experience/' ) ); ?>
				</p>
			</div>
		</div>
		...
		<div class="about__section has-2-columns">
			<div class="column">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
 printf( __( 'Explore the <a href="%1$s">WordPress %2$s Field Guide</a>. Learn about the changes in this release with detailed developer notes to help you build with WordPress.' ), __( 'https://make.wordpress.org/core/2023/10/23/wordpress-6-4-field-guide/' ), '6.4' ); ?>
				</p>
			</div>
			<div class="column">
				<div class="about__image">
				...
				<p style="margin-top:calc(var(--gap) / 2);">
					<?php
 printf( __( '<a href="%1$s">Read the WordPress %2$s Release Notes</a> for information on installation, enhancements, fixed issues, release contributors, learning resources, and the list of file changes.' ), sprintf( esc_url( __( 'https://wordpress.org/documentation/wordpress-version/version-%s/' ) ), '6-4' ), '6.4' ); ?>
				</p>
			</div>
		</div>
